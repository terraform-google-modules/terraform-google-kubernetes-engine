...
package simple_autopilot_private_cmek
...
func TestSimpleAutopilotPrivateCMEK(t *testing.T) {
	...
	bpt.DefineVerify(func(assert *assert.Assertions) {
		...
		key := bpt.GetStringOutput("boot_disk_kms_key")
		...
		assert.Equal(op.Get("autoscaling.autoprovisioningNodePoolDefaults.bootDiskKmsKey").String(), key, "should have CMEK configured")
	})
	bpt.Test()
}
