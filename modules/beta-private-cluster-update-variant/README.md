...
| allow\_net\_admin | (Optional) Enable NET\_ADMIN for containers in this cluster. This is a powerful capability. For more information, see https://cloud.google.com/kubernetes-engine/docs/how-to/hardening-your-cluster#restrict_pod_permissions | `bool` | `null` | no |
