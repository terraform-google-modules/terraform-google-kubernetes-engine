...
echo -e "REVISION_LABEL is $REVISION_LABEL"
...
if [[ "${REVISION_LABEL}" = "none" ]]; then
    REVISION_LABEL_COMMAND_SNIPPET=""
else
    REVISION_LABEL_COMMAND_SNIPPET="--revision-name ${REVISION_LABEL}"
fi
