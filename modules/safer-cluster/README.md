...
More examples can be found in the [examples](https://github.com/terraform-google-modules/terraform-google-kubernetes-engine/blob/master/examples) 
folder. A basic configuration is the following.

```
module "gke" {
  source                     = "terraform-google-modules/terraform-google-kubernetes-engine/modules/safer-cluster"
