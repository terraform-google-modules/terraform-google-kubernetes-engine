...
| enable\_k8s\_tokens\_via\_dns | (Optional) Controls whether K8s tokens are enabled via the DNS endpoint. Defaults to true if dns\_allow\_external\_traffic is set. | `bool` | `null` | no |
