...
| service\_external\_ips | Whether external ips specified by a service will be allowed in this cluster. Set to null to leave the setting unmanaged. | `bool` | `null` | no |
