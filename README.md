...
| network\_policy\_provider\_enabled | Enable network policy provider: 'CALICO'. When set to 'true' it requires 'network_policy=true' to work properly. | bool | false | no |
