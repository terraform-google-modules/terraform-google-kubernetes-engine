...
| terraform\_timeouts | Timeouts for Terraform operations. | `object({create = string, update = string, delete = string})` | <pre>{<br>  "create": "45m",<br>  "delete": "45m",<br>  "update": "45m"<br>}</pre> | no |
